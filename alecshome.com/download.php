	...
	<body id="body">
		<div id="main" class="card" style="width: 257px; margin: 0; position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%);">
			...
			<div id="info">
				...
				else if (!file_exists('AlecsCP/data/uploads/' . $_GET['file'] . ".txt")) { echo '<p><strong> Error getting file: </strong><br> File not found! <br> The file may have been deleted. </p><br><h2 class="button" style="margin: 0;" onclick="readMe()"> <a>View More Information</a> </h2>'; }
				else {

				$data = explode("~", file_get_contents('AlecsCP/data/uploads/' . $_GET['file'] . ".txt"));
				$size = $data[0];
				$description = $data[1];
				$date = $data[2];
				...
				<a href="https://alecshome.com/downloads/' . $_GET['file'] . '" onclick="downloading()" id="copyLinkBtn" download> <h2 id="downloadBtn" class="button" style="margin: 0;"> Download File</h2> </a>';

				} ?>
			</div>
			<div id="readme" style="display: none;">
				<h3> What is this?</h3>
				<p> This is my custom file hosting service used to temporarially allow downloading for a certain file. </p>
